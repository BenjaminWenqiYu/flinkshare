 ...
 */
public class StreamWindowWatermark2 {
    public static void main(String[] args) throws Exception {
        ...
        // 设置使用event-time，默认使用process-time
        ...
        SingleOutputStreamOperator<String> window = waterMarkStream.keyBy(0)
                ...
                .apply(new WindowFunction<Tuple2<String, Long>, String, Tuple, TimeWindow>() {
                    ...
                    public void apply(Tuple tuple, TimeWindow window, Iterable<Tuple2<String, Long>> input,
                        ...
                        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
                        String result = key + "," + array.size() + "," + sdf.format(array.get(0)) + "," +
                                sdf.format(array.get(array.size() - 1)) + "," + sdf.format(window.getStart()) +
